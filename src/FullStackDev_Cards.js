...
const FullStackDev_Cards = () => (
  <Card.Group itemsPerRow={4}>
    ...
    <Image src={FSWeb_1} size="massive"/>
      <Card.Description>
        <Card.Header>Unsure how to solve a coding problem</Card.Header>
      </Card.Description>
    </Card>
    ...
    <Image src={FSWeb_2}/>
    <Card.Description>
        <Card.Header>Decide to try it out</Card.Header>
      </Card.Description>
    </Card>
    <Card color="green" >
    <Image src={FSWeb_3}/>
    <Card.Description>
        <Card.Header >Run the program and it works</Card.Header>
      </Card.Description>
    </Card>
    <Card color="blue" >
    <Image src={FSWeb_4}/>
    <Card.Description>
        <Card.Header>Joy of program working</Card.Header>
      </Card.Description>
    </Card>
  </Card.Group>
);
