      ...
      case 1:
       return (
          <Card color="blue" centered>
            ...
            <Card.Header style={{textAlign:"center", fontSize:"1.5rem"}}>Certificate - Feb. 2019</Card.Header>
          </Card>
        );
        case 2:
       return (
          <Card color="blue" centered style={{padding:"5% 5% 0 5%"}}>
            <ImageChange src={uh} />
            <Card.Header style={{textAlign:"center", fontSize:"1.5rem"}}>Bachelor of Science - May 2014</Card.Header>
          </Card>
        );
      ...
      <Container>
        <Grid>
          <Grid.Row columns={2}>
            ...
            <Grid.Column className="my-auto" >{this.renderPicture()}</Grid.Column>
          </Grid.Row>
        </Grid>
      </Container>
    );
